...
def DownloadImagesAndCreateCustSV(searchTerm, _downloadImages):

    cards = GetCardUniquePrintsByName(cardName=searchTerm)
    ...
    if downloadImages == _downloadImages:
...
def InitializeProject(searchTerms, downloadImages):
        
    for term in searchTerms:

        DownloadImagesAndCreateCustSV(searchTerm=term, _downloadImages=downloadImages)
